...
$GLOBALS['album_comment'] = 'Welcome to our photo album!  We hope that you enjoy your ' .
  'stay!';
...
$GLOBALS['thumbnail_max_height'] = $GLOBALS['thumbnail_max_width'] / (4/3); // measured in pixels
    // Using the formula "width / (4/3)" maintains the same aspect ratio
    // as monitors, televisions, etc.
$GLOBALS['thumbnail_quality'] = 50; // A number between 1 and 100, with 1 looking really
...
$GLOBALS['top_number']          = 20;	# The number of pictures to show in 
...
$GLOBALS['login_timeout'] = 900;  // 15 minutes
...
$GLOBALS['big_image_h'] = 600;  // Should show up fine
