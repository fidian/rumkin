...
$Things = array(
	'Avery "Write-On Cling Sheets"' => array(
		...
		'avery',
		'Reported to work',
		'Reported to work very well.  It is just like a whiteboard that ' . 'you can stick to the walls.  The 27" x 32" might be a bit ' . 'small for your purposes, but it would work great for a small ' . 'office whiteboard.  My only questions are about durability and ' . 'long-term marker stains.'
	),
	'Appliances' => array(
		4,
		1,
