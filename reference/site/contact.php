...
StandardHeader(array('title' => 'Contact / Feedback Form',
		     'topic' => 'rumkin'));
...
<?= HideEmail('fidian', 'rumkin.com') ?> or use this online feedback
...
function SendEmail()
{
    if (isset($_POST['from']) || isset($_POST['subj']) ||
        isset($_POST['body']))
    {
        $err = array();
	...
	if (! isset($_POST['from']) || $_POST['from'] == '' ||
	    ! strpos($_POST['from'], '@'))
	    $err[] = 'You must enter a good "from" address.';
	if (! isset($_POST['subj']) || $_POST['subj'] == '')
	    $err[] = 'You must enter a good subject.';
	if (! isset($_POST['body']) || $_POST['body'] == '')
	    $err[] = 'You need to enter a message.';
	...
	mail('fidian@rumkin.com', '[Rumkin.com] ' . $_POST['subj'],
