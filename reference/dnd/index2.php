...
MakePageList('Ultimate Equipment Guide - Armory - Armors',
	     'ueg-armory-armor', 14);
...
function ShowCosts($info)
{
    ...
    foreach ($info as $k => $g)
    {
	echo "<tr><td>" . htmlspecialchars($k) . '</td><td>&nbsp;</td>' .
	  "<td align=right>" . number_format($g) . "</td></tr>\n";
	$gold -= $g;
    }
    echo "<tr><th>Gold Left</th><td>&nbsp;&nbsp;</td><td align=right><b>" . 
      number_format($gold) . "</b></td></tr>\n";
    echo "</table>\n";
}
