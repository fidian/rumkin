...
$Skills = array(
	...
	'Craft (pick type)' => array(
		'int',
		1
	),
	'Decipher Script' => array(
		'int',
		0
	),
	'Diplomacy' => array(
...
foreach ($Skills as $Name => $Info) {
	if ($Name == '') {
		...
		if ($Info[1])echo '<td align=center>Yes</td>';
