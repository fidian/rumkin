...
function KeymakerToggle(id) {
    ...
    if (e.getAttribute("_showKeymaker") != "show") {
        o =
            '<a href="#" onclick="return KeymakerToggle(' +
            id +
            ')">Show Keymaker</a>';
        e.innerHTML = o;
    ...
    o =
        ...
        id +
        '"><br>' +
        '<input type=checkbox id="KeymakerLastInstance' +
        id +
        '"> Use last instance of letter instead of first<br>' +
        '<input type=checkbox id="KeymakerRevKey' +
        id +
        '"> Reverse keywords<br>' +
        '<input type=checkbox id="KeymakerRevAlpha' +
        id +
        '"> Reverse alphabet<br>' +
        '<input type=checkbox id="KeymakerKeyOnRight' +
        id +
        '"> Put keywords on right side<br>' +
        'Result: <b><span id="KeymakerResult' +
        id +
        '"></span></b> ' +
        "&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; " +
        '<a href="#" onclick="return KeymakerApply(' +
        id +
        ')">Apply ' +
        "to Key</a>" +
        "</td></tr></table><br>";
