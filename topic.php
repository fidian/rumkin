...
if (isset($_POST['f_name']) && isset($_POST['f_mesg']))
{
    ...
    Redirect('/topic.php' .
	     '?&msg=' . urlencode($Msg) . '&theme=' . urlencode($theme) .
	     '&topic=' . urlencode($topic) . '&time=' .
	     time());
}
...
{
    echo "<b>" . $GLOBALS['Post Message'][$_GET['msg']] . 
      "</b><br>\n";
}
...
<link rel="stylesheet" type="text/css" href="/inc/css/<?= $theme ?>.css">
<body class="r_chat">
<?PHP
