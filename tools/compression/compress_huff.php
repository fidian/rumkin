...
//   Letters[54] = 1;
   ...
   while (Depth >= 0)
   {
	 ...
	 NextFinal ++;
      ...
      else if (NodeChild1[DepthIndex[Depth]] < 0 &&
         NodeChild2[DepthIndex[Depth]] > -1)
      {
	 ...
	 DepthIndex[Depth] = idx;
      ...
      // If there was a left and a right, but they were both taken,
      // pop up a level
      else if (NodeChild1[DepthIndex[Depth]] < -1 &&
         NodeChild2[DepthIndex[Depth]] < -1)
      {
         Depth --;
      }
