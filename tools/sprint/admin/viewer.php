...
if (isset($_GET['filter']))
  $GLOBALS['filter'] = split(',', $_GET['filter']);
if (isset($_POST['filter']))
  $GLOBALS['filter'] = $_POST['filter'];

if (isset($_GET['size']))
  $GLOBALS['size'] = $_GET['size'];
if (isset($_POST['size']))
  $GLOBALS['size'] = $_POST['size'];
...
ShowTableWithLinks($showable, array('CellCallback' => 'GetCellData',
				    'DoFilter' => true));
...
function GetCellData($data)
{
    ...
    echo $fn . ' &ndash; ' . FidianFileSize($data['FileSize'],
							true, true) .
      "\n";
    echo "</td>\n";
}