...
$GLOBALS['Only Provider Emails'] = 1;  // 0 or 1

// Should I send SMS messages through Sprint's web site or use email?
$GLOBALS['Use Sprint Website'] = 1;  // 0 or 1
...
$GLOBALS['File Types'] = array(
    0 => array('*', 'application/octet-stream', 'The default MIME type.', 0),
    1 => array('gcd', 'text/x-pcs-gcd', 'Sprint PCS GCD files.', 0),
    2 => array('qcp', 'audio/vnd.qcelp', 'Compressed audio.', 2),
    3 => array('jad', 'text/vnd.sun.j2me.app-descriptor',
	       'Java midlet descriptor.', 0),
    4 => array('jar', 'application/java-archive',
	       'Java midlet.  May alternatively be ' .
	       'application/x-java-archive', 0),
    5 => array('wbmp', 'image/vnd.wap.wbmp', 'Wireless bitmap -- not a ' .
	       'Windows bitmap.', 1),
    6 => array(array('jpg', 'jpe', 'jpeg'), 'image/jpeg', 
	       'JPEG compressed image.', 1),
    7 => array('png', 'image/png',
	       'PNG compressed image.', 1),
    8 => array('pmd', 'application/x-pmd',
	       'Animation.', 0),
    9 => array(array('mid', 'midi'), 'audio/midi', 'MIDI sound sequence.', 2),
    10 => array('txt', 'text/plain', 'Text files.', 0),
    11 => array('gif', 'image/gif', 'GIF compressed image.', 1),
    12 => array('mp3', 'audio/mp3', 'MP3 File.', 2),
    13 => array('mmf', 'application/vnd.smaf', 'MMF Audio File.', 2),
    14 => array('mp4', 'video/mp4', 'MP4 Video.', 0),
    15 => array('m4a', 'audio/mp4', 'M4A Audio.', 2),
    16 => array('amr', 'audio/3gpp', 'AMR Audio.', 2),
    17 => array(array('3gp', '3gpp'), 'video/3gpp', 
		'3GP Audio/Video/Text.', 0),
    18 => array('wma', 'audio/x-ms-wma', 'WMA Audio.', 2),
    19 => array('wav', 'audio/x-wav', 'WAV Audio.', 2),
    20 => array('cab', 'application/octet-stream', 'CAB files.', 0),
    21 => array('aac', 'audio/x-aac', 'AAC Audio.', 2),
    22 => array('bar', 'x-pcs/theme', 'Sprint PCS Theme', 0),
);
...
$GLOBALS['File Match Message'] = 'You can only upload files of these types:  ' .
    '3gp, aac, amr, bar, cab, gif, jpg, jpeg, ' .
    'gcd, m4a, mid, midi, mmf, mp3, mp4, ' .
    'pmd, png, qcp, wav, wbmp, wma';

$GLOBALS['Jar Match'] = '/\\.jar$/i';
$GLOBALS['Jar Match Message'] = 'Only .jar files can be used in the JAR ' .
    'section.';
...
$GLOBALS['Ban Phone'] = array('911', '1112223333');