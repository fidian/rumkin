...
echo "<p>Below are sites that deal with mobile phones, have content " .
  "available for you to download, or contain information that may " .
  "be useful.  If you know of other sites, feel free to email " .
  "me about them.</p>";

Section('Ringers, Wallpapers, and Other Phone Files');

$Links = array(
   array('Name' => 'Cellfiles',
	 'Desc' => 'A forum where you can post and request ringers, apps, ' .
	           'games, and videos.  Need stuff to send to your phone?',
...
$Links = array(
   array('Name' => '2 ur Phone',
	 'Desc' => 'An alternate uploader that uses its own custom ' .
	           'software.  If you try this, let me know how well ' .
	           'it works.',
	 'URL' => 'http://www.2urphone.com/'),
   array('Name' => '3G Inferno',
	 'Desc' => 'A blended site that hosts both my old and newer ' .
	           'uploader, so you can upload .jar files with ' .
	           '.jad if you have them.',
	 'URL' => 'http://www.3ginferno.com/uploaders/'),
   array('Name' => 'a9000 Upload',
	 'Desc' => 'Formats files so you can use QPST to transfer them ' .
	           'to your phone with a USB cable.  Doesn\'t do any ' .
	           'uploading itself; it helps make the required files ' .
	           'to use QPST effectively.',
   ...
   array('Name' => 'CellPhoto',
	 'Desc' => 'Another uploader site that was mentioned in the ' .
	           'shoutbox.',
	 'URL' => 'http://www.cellphoto.net/'),
   array('Name' => 'Chris On The Web',
	 'Desc' => 'My uploader, but skinned to look better and with an ' .
	           'improved gallery.',
	 'URL' => 'http://www.chrisontheweb.net/cellphones/'),
   array('Name' => 'Cybertooth',
	 'Desc' => 'Another copy of my software, who actually volunteered ' .
	           'to help take traffic off my site instead of me finding ' .
		   'them with Google.',
	 'URL' => 'http://cybertooth64.com/uploader/'),
   array('Name' => 'gtoal.com',
         'Desc' => 'An earlier version of my uploader.  If you have ' .
	           'problems uploading a .jar that you think should ' .
		   'work, make sure that you have the .jad handy and ' .
		   'try this uploader.',
   ...
   array('Name' => 'LiquidFish',
	 'Desc' => 'Modified copy of a very early version of my uploader.',
	 'URL' => 'http://www.liquidfish.net/mobile/'),
   array('Name' => 'Lumine.net',
	 'Desc' => 'My uploader on another site.  I\'m glad that people ' .
	           'like it so much.',
	 'URL' => 'http://lumine.net/pcs/'),
   array('Name' => 'Lunarnexus',
	 'Desc' => 'Another mirror of my uploader.  Plain looking but ' .
	           'that just means it loads faster.',
	 'URL' => 'http://www.lunarnexus.com/uploader/'),
   array('Name' => 'MobileReelz',
	 'Desc' => 'Nice ringtone uploader.  Upload your MP3 file, chop ' .
	           'it down to a ringer, then send it to your phone.',
   ...
   array('Name' => 'Total Uploader',
	 'Desc' => 'This file sender appears to use its own code to send ' .
	    'images, PRC files, zip files, Java midlets, and plain text ' .
	    'messages to phones.',
...
$Links = array(
   array('Name' => 'Atlanta Journal-Constitution :: Geekboy',
	 'Desc' => 'A write-up on how to create and send ringers to ' .
	           'your phone.',
	 'URL' => 'http://www.ajc.com/blogs/content/shared-blogs/ajc/' . 
	          'geek/entries/2006/03/16/my_ringaling.html'),
   array('Name' => 'CMX FAQ',
...
$Links = array(
   ...
   array('Name' => 'MiniSendNote',
	 'Desc' => 'Tiny program to send messages from a Sprint phone ' . 
	           'without forcing you to use their annoying WAP system.',
