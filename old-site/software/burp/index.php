...
$Files = array(
	'burp-gui.exe' => array(
		'Windows GUI (everything you need)',
		'2e6aba649c3cadef963f4ed1b45b7d01'
	),
	'burp-gui.zip' => array(
		'Windows GUI and the AutoIt 3 source code',
		'f6dc2570e0e153d9c713a3b832ba0fa8'
	),
	'burp.exe' => array(
		'DOS executable (UPX compressed)',
		'4ea4781a80e2f2fe331c01f66a2a39fd'
	),
	'burp32.exe' => array(
		'DOS/Win32 console executable (UPX compressed)',
		'96e40333aad9006ab34fcefb43716e84'
	),
	'burp' => array(
		'Linux executable (UPX compressed)',
		'332bb15fe2c69b85ea3e21fcdc905500'
	),
	'burp120.zip' => array(
		'Mirror of the BURP 1.20 archive',
...
foreach ($Files as $n => $d) {
	...
	echo "<li><a href=\"media/$n\">$n</a> (" . FidianFileSize($mediaFile) . ") - $d[0] <font size=-2>(md5: $d[1])</font>\n";
}
