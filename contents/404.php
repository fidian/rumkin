...
$keywords = array(
	...
	array(
		...
		'/reference/web/desc.php',
		'description'
	),  // 2005 02 19
	array(
		'PHP Contest Site - Codewalkers',
		'/reference/php_contest/',
		'php_contest'
	),
	array(
		'Whiteboard Construction and Cleaning',
	...
	array(
		'Diablo II Hack Pack',
		'http://forum.rumkin.com/?action=vtopic&forum=1',
		'diablo'
	),
	array(
		'Java Puzzle Applet',
	...
	array(
		'Kits - Palm OS software bundler',
		'/software/kits/',
		'kit'
	),
	array(
		'Marco - Palm OS Survey Software',
		'/software/marco/',
		'marco'
	),
	array(
		'Caesar Shift',
		'/tools/cipher/caesar.php',
		'rotn'
	),
	array(
		'Cryptogram Solver',
		'/tools/cipher/cryptogram.php',
		'crypto'
	),
	array(
		'ROT13 Encryption',
		'/tools/cipher/rot13.php',
		'rot13'
	),
	array(
		'Java IRC Client',
	...
	array(
		'Email Mailto Encoder',
		'/tools/mailto_encoder/',
		'mailto encoder'
	),
	array(
		'Sprint PCS Vision Uploader',
		'/tools/sprint/',
		'sprint'
	),
	array(
		'Fun Stuff - Content Listing',
		'/fun/',
		'fun'
	),
	array(
		'Reference - Content Listing',
		'/reference/',
		'reference'
	),
	array(
		'Software - Content Listing',
		'/software/',
		'project software'
	),
	array(
...
foreach ($redirects as $from => $to) {
	if (strtolower(substr($_SERVER['REDIRECT_URL'], 0, strlen($from))) == $from) {
		$new_path = $to . substr($_SERVER['REDIRECT_URL'], strlen($from));
		Redirect($new_path, array(
				'permanent' => 1
			));
	}
}
