...
<ul>
<li><font color="<?php echo $GLOBALS['MyTheme']['link'] ?>"><u>Link color</u></font>
<li><font color="<?php echo $GLOBALS['MyTheme']['alink'] ?>"><u>Active color</u></font>
<li><font color="<?php echo $GLOBALS['MyTheme']['vlink'] ?>"><u>Visited color</u></font>
</ul>
...
<input type=hidden name=math value=<?php echo $math ?>>
...
<p><input type=checkbox name=math<?php

if ($math)echo ' CHECKED';
