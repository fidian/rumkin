...
$Links = array(
	...
	array(
		'Name' => 'AwStats by Directory',
		'Desc' => 'Custom form that lets you view hits by directory.',
		'URL' => 'awstats.php'
	),
	array(
		'Name' => 'AwStats',
		'Desc' => 'Web site statistics.  Nearly everything you would ' . 'ever be curious about.',
	...
	array(
		'Name' => 'Theme Tester',
		'Desc' => 'Tests the themes on this server so I can see what a ' . 'particular change would do to web pages.',
		'URL' => 'theme.php'
	),
);
MakeLinkList($Links);
