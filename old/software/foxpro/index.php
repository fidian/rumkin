...
$Links = array(
	array(
		'Name' => 'Functions',
		'Desc' => 'Usually very short snippets of code that assist ' . 'with repetitious tasks.',
		'URL' => 'functions.php'
	),
	array(
		'Name' => 'Links',
		'Desc' => 'Various off-site links that have valuable tips and ' . 'more things that you can download.',
		'URL' => 'links.php'
	),
	array(
		'Name' => 'Packages',
		'Desc' => 'Groups of files that I have found on the internet.  ' . 'Each one includes whatever I was able to download and there ' . 'is at least one example showing how to use the code.',
		'URL' => 'packages.php'
	),
);
MakeLinkList($Links);
