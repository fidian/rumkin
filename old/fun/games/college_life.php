...
when someone offers you another beer for the road.  What do you do?',
		array(
			1 => 'Decline and head for your room',
			2 => 'Drink beer'
		),
		1
	),
...
do?',
		array(
			10 => 'Decline and continue to your room',
...
you\'ve gone to the wrong class.  What do you do?',
		array(
			12 => 'Sit through the class to avoid embarrassment',
			13 => 'Discretely leave'
		),
		0
	),
...
What do you do?',
		array(
			20 => 'Apologize and head to your next class',
			21 => 'Call the dean of students, pretending to be ' . 'a high-priced lawyer'
		),
		0
	),
	17 => array(
...
you do?',
		array(
			25 => 'See what this club is about',
			26 => 'Recognize these people as the Christian ' . 'lunatics they are'
		), - 1
	),
	21 => array(
		"
...
What do you do?',
		array(
			29 => 'Find out what the hot-tubbers are up to',
...
They ask if you care to join them.  What do you do?',
		array(
			32 => 'Join the hot-tubbers and jump in',
...
My name\'s..."  She slumps to the floor, passed out cold.  What do you do?',
		array(
			37 => 'Try to get her to her room, wherever it is',
			38 => 'Try to place her on your bed so she can ' . 'sleep and maybe feel better',
...
It kind of tickles!  What do you do?',
		array(
			43 => 'Let her keep doing what she is doing',
...
bed. What do you do?',
		array(
			41 => 'Lie there and try to appear asleep',
			42 => 'Run screaming from the room'
		), - 4
	),
	40 => array(
...
if (! isset($PageData[$page]))$page = 0;

if (! isset($_SESSION['Beers']))$_SESSION['Beers'] = 0;

if (! isset($_SESSION['BeerCount']))$_SESSION['BeerCount'] = 0;
$P = $PageData[$page];
$_SESSION['Beers'] += $P[2];

if ($_SESSION['Beers'] < 0)$_SESSION['Beers'] = 0;

if ($P[2] > 0)$_SESSION['BeerCount']++;
$oldpage = $page;

if ($_SESSION['Beers'] > 6 && $page == 2)$page = 6;

if ($_SESSION['Beers'] > 7 && $page == 15)$page = 19;

if ($_SESSION['Beers'] > 12 && $page == 33)$page = 36;
...
foreach ($P[1] as $pnew => $desc) {
	echo '<li><a href="' . $PHP_SELF . '?page=' . $pnew . '">' . $desc . "</a>\n";
}
