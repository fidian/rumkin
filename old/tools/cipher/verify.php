...
$GLOBALS['Tests'] = array(
	...
	'Skip Encode (1,0)' => array(
		'"Hello Baby"',
		'Skip(1, "Hello Baby", 1, 0)'
	),
	'Skip Encode (3,5)' => array(
		'"b lyBlHaoe"',
		'Skip(1, "Hello Baby", 3, 6)'
	),
	'Skip Encode (8,8)' => array(
		'"lacizziuQ"',
		'Skip(1, "Quizzical", 8, 8)'
	),
	'Skip Decode (1,0)' => array(
		'"Hello Baby"',
		'Skip(-1, "Hello Baby", 1, 0)'
	),
	'Skip Decode (3,5)' => array(
		'"Hello Baby"',
		'Skip(-1, "b lyBlHaoe", 3, 6)'
	),
	'Skip Decode (8,8)' => array(
		'"lacizziuQ"',
		'Skip(-1, "Quizzical", 8, 8)'
	),
	'Ubchi Encode' => array(
...
<?php
	...
	foreach (array(
		...
		echo '   if (! document.' . $F . '_Loaded) s += "Loading ' . $F . ' ...<br>\\n";' . "\n";
	}
...
<?php
	...
	foreach ($GLOBALS['Tests'] as $n => $t) {
		...
		?>
   if (<?php echo $t[0] ?> == <?php echo $t[1] ?>)
   {	
      s += "<tr bgcolor=#BBFFBB><th><?php echo $n
		
		?></th><td align=center>Pass</td></tr>\n";
   }	
   else
   {	
      s += "<tr bgcolor=#FFBBBB><th><?php echo $n
		
		?></th><td align=center>FAIL -- Want : <b>" + <?php echo $t[0]
		
		?> + "</b><br>Got : <b>" + <?php echo $t[1] ?> + "</b></td></tr>\n";
   }
<?php
	}
