...
if ('personal' == $personal['theme'])echo ' SELECTED';
echo ">personal</OPTION>\n";

for ($index = 0; $index < count($list); $index ++) {
	echo '<OPTION';
	
	if ($list[$index] == $personal['theme'])echo ' SELECTED';
...
?>
      ...
      <tr>
        ...
        <td>
          <input type="radio" name="pref[THM_PG_TXT_SZ]" value="xx-small" <?php

if ('xx-small' == $theme['thm_pg_txt_sz'])echo 'CHECKED'; ?>>xx-small 
          <input type="radio" name="pref[THM_PG_TXT_SZ]" value="x-small" <?php

if ('x-small' == $theme['thm_pg_txt_sz'])echo 'CHECKED'; ?>>x-small 
          <input type="radio" name="pref[THM_PG_TXT_SZ]" value="small" <?php

if ('small' == $theme['thm_pg_txt_sz'])echo 'CHECKED'; ?>>small 
          <input type="radio" name="pref[THM_PG_TXT_SZ]" value="medium" <?php

if ('medium' == $theme['thm_pg_txt_sz'])echo 'CHECKED'; ?>>medium 
          <input type="radio" name="pref[THM_PG_TXT_SZ]" value="large" <?php

if ('large' == $theme['thm_pg_txt_sz'])echo 'CHECKED'; ?>>large 
          <input type="radio" name="pref[THM_PG_TXT_SZ]" value="x-large" <?php

if ('x-large' == $theme['thm_pg_txt_sz'])echo 'CHECKED'; ?>>x-large 
          <input type="radio" name="pref[THM_PG_TXT_SZ]" value="xx-large" <?php

if ('xx-large' == $theme['thm_pg_txt_sz'])echo 'CHECKED'; ?>>xx-large 
        </td>
      ...
      <tr>
        ...
        <td><input type="text" name="pref[START_DIR]" value=<?php

if (isset($personal['start_dir']))echo "\"$personal[start_dir]\"" ?>></td>
        <td>&nbsp</td>
        <td>Current: "<?php
...
if (isset($personal['start_dir']))echo "$personal[start_dir]" ?>"</td>
      ...
      <tr>
        <td>Hidden Files:</td>
        <td>
        	<input type="radio" name="pref[SHOW_HIDDEN]" value="hide" <?php

if ($personal['show_hidden'] == false)echo 'CHECKED' ?>> Hide
        	<input type="radio" name="pref[SHOW_HIDDEN]" value="show" <?php

if ($personal['show_hidden'])echo 'CHECKED' ?>> Show
        </td>
        <td>&nbsp</td>
        <td>Current:
        	<?php

if ($personal['show_hidden'])echo '"Show"';
else echo '"Hide"';
