...
$Cleaners = array(
	array(
		...
		'If you intend to use this as a cleaner indoors, make sure that you do your cleaning away from flame and turn on the fans!  The major drawback of this cleaner is that you get a nasty chemical smell.  Acetone is also the primary ingredient in <a href="#nail_polish_remover">nail polish remover</a>.'
	),
	array(
		'Alcohol, Isopropyl',
		'Generic',
	...
	array(
		...
		'I do want to note that I did not want to actually try something like this because I saw no merit in the cleaner.  However, I wanted to be very thorough, and that\'s the <i>only</i> reason it is included in the test.'
	),
	array(
		'Cleaner',
		'Lift Off 2',
	...
	array(
		...
		'Sorry about the lack of a picture.  Just look at the one for <a href="#vinegar">vinegar</a> instead; they have the exact same cleaning power.'
	),
	array(
		'Dish Soap',
		'Dawn',
		...
		'Removed wet and dry erase',
		'soapy_water.jpg',
		'It worked about the same as <a href="#cloth_wet">plain water</a>.  Well, just a tiny bit better, but the difference was minimal.'
	),
	array(
		'Eraser Pad',
		'Mr. Clean',
	...
	array(
		...
		'If you are going to buy a product to clean your board, I strongly suggest this one!  After the test, we cleaned the whole 4\' x 8\' board with just a few tablespoons of the cleaner and it removed the <a href="#baby_oil">baby oil</a>, <a href="#lysol">Lysol Kitchen Cleaner</a> film, and other residues that remained from the other cleaners we were testing.',
	...
	array(
		...
		'This acted just like a slightly stronger <a href="#vinegar">vinegar</a>.  The amount removed was minimal.'
	),
	array(
		'Mixture',
		'Vinegar & Orange Glow',
	...
	array(
		...
		'When I say "<a href="#acetone">acetone</a>," people think it is a nasty chemical.  When I say "nail polish remover," people get a different impression and they think it isn\'t as harsh.  Well, nail polish remover is basically acetone, and the two performed similarly.  Nail polish remover is a bit easier to find, and they both removed most of the marks and slightly smeared the ink.  They also both evaporated away, leaving a clean whiteboard surface.  It did completely remove the dull sheen that whiteboard markers can leave on the surface.'
	),
	array(
		'Orange Cleaner',
		'Fantastik',
...
foreach ($Cleaners as $k => $Cleaner) {
	...
	?>
	<tr>
		<td><a href="#<?php echo $Cleaner[4] ?>"><?php echo htmlspecialchars($Cleaner[0]) ?></a></td>
		<td><?php echo htmlspecialchars($Cleaner[1]) ?></td>
		<td><?php echo Rate($Cleaner[2]) ?></td>
		<td><?php echo Rate($Cleaner[3]) ?></td>
		<td><?php echo htmlspecialchars($Cleaner[5]) ?></td>
	</tr>
<?php
}
