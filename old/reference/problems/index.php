...
$Pages = array(
	'averatec_6200' => array(
		'Name' => 'Linux on Averatec 6200',
		'Desc' => 'Tips on getting Linux running ' . 'smoothly on this type of laptop.',
		'URL' => 'averatec_6200.php'
	),
	'csnw' => array(
		'Name' => 'CSNW',
		'Desc' => 'Open a DOS shell and get "<tt>Cannot load VDM ' . 'IPX/SPX support</tt>"',
		'URL' => 'csnw.php',
		'Escape' => false
	),
	'export_qa_to_excel' => array(
		'Name' => 'Export Query Analyzer to Excel',
		'Desc' => 'Are you missing column headers ' . 'when you cut and paste your Query ' . 'Analyzer results into an Excel table? ' . 'Learn how to get them there quickly ' . 'and easily.',
		'URL' => 'export_qa_to_excel.php'
	),
	'sdif' => array(
		'Name' => 'SDIF',
		'Desc' => 'You need to restore files from a Novell ' . 'backup to a non-Novell system, but the files appear ' . 'to be corrupt when resored.',
		'URL' => 'sdif.php'
	),
	'time_diff' => array(
		'Name' => 'Time Difference',
		'Desc' => 'When you try to log into a Windows domain, ' . 'you get the error "<tt>There is a time ' . 'difference between the client and server.</tt>"',
		'URL' => 'time_diff.php',
		'Escape' => false
	),
);
...
foreach ($TopicPage as $k => $v) {
	echo "<hr>\n";
	echo '<p><b><font size="+1"><a name="' . MakeAnchor($k) . "\"></a>$k</font></b></p>\n";
	$Links = array();
